    ...
    return (
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 13, color: 'rgba(var(--fg-rgb),0.55)', margin: '0 0 20px', lineHeight: 1.5 }}>
          ...
          {this.state.message && (
            <p style={{ fontSize: 11, color: 'rgba(var(--fg-rgb),0.3)', marginTop: 16, wordBreak: 'break-word' }}>
              {this.state.message}
            </p>
          )}
        </div>
