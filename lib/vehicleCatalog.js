...
export const VEHICLES = {
  ...
  // Force, Ashok Leyland and Eicher are primarily commercial truck/bus manufacturers —
  // this catalog is scoped to passenger vehicles a garage services for individual
  // customers, so only Force's genuine passenger model (Gurkha) is kept, and Ashok
  // Leyland / Eicher (whose only models here — Dost/Bada Dost/Partner, Pro
  // 2049/2059/3015 — are all light/medium commercial trucks) are removed entirely.
  Force: ['Gurkha'],
