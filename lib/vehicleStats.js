 ...
 * an invoice may move stock or write to the ledger, so drafts, estimates, cancelled
 * and refunded invoices contribute nothing.
 *
 * NOTE (Phase 23 deep re-audit): this is the invoice `grand` total, i.e. **GST-inclusive
 * per-vehicle turnover** — deliberately a different metric from the operational
 * dashboard / Sales / Reports "Revenue", which is the ex-GST sales-ledger figure. Both
 * are internally consistent; they differ by the tax amount, by design.
 */
