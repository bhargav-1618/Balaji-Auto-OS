...
// Refactor Phase 3 — ServicesView moved verbatim from InventoryDashboard.js to
// ./inventory/views/LedgerViews; the SERVICES-SPECIFIC content asserted below lives there now.
